...
GEMINI_API_KEY = os.getenv("AIzaSyBxwBFaCxAn0ssEaxZANUmIXi4WrdA9A3o")

# === PDF to Text ===
PDF_PATH = "cv.pdf"  # Make sure this file is in the root of your repo
...
def extract_resume_text(path):
    try:
        ...
        for page in doc:
            text += page.get_text()
        return text.strip()[:16000]  # Gemini character limit
...
"""
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("[ERROR] Gemini API returned:", response.status_code, response.text)
